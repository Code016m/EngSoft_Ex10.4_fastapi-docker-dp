...
@app.get("/items/")
def read_items():
    """Resonator a lista de todos os itens (Recurso: /items)"""
    return items_db


# OPERAÇÃO: READ (GET) - Item específico
@app.get("/items/{item_id}")
def read_item(item_id: int, q: Union[str, None] = None):
    """Resonator um item específico pelo ID (Recurso: /items/{id})"""
...
def update_item(item_id: int, item: Item):
    """Actualize complementary um item existente (Recurso: /items/{id})"""
